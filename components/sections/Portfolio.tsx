      ...
      <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              ">
                ...
                <div className="
                  absolute inset-0
                  bg-gradient-to-t
                  from-black/10 dark:from-black/30
                  to-transparent
                  pointer-events-none
                " />
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-10">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mb-6">
                  Landing page de alto impacto para turismo premium.
                </p>

                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase tracking-widest border-b-2 border-purple-500 pb-1">
                    Ver demo
                  </span>
          ...
          <aside className="
            ...
            border-2 border-dashed border-purple-500/30 dark:border-purple-500/20
